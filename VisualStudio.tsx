...
export const VisualStudio: React.FC<VisualStudioProps> = ({ exercise, onVisualGenerated }) => {
  ...
  const [currentLayout, setCurrentLayout] = useState<'grid-4x4' | 'grid-5x5' | 'grid-6x4'>((exercise.visualLayout as 'grid-4x4' | 'grid-5x5' | 'grid-6x4') || 'grid-4x4');
  ...
  const constructPrompt = () => {
    // Uses the modular Prompt Engine
    setGeneratedPrompt(VisualPrompts.construct(exercise, activeLayer));
  };
