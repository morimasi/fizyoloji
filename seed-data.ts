...
export const SEED_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    description: 'Bir basamakta veya düz zeminde ayak parmak uçlarınızda yükselin and yavaşça inin.',
    biomechanics: 'Gastrocnemius and Soleus kuvveti, ayak bileği stabilitesi.',
    safetyFlags: ['Aşil Tendiniti (Akut)'], equipment: ['Yok'], primaryMuscles: ['Calves'],
    rehabPhase: 'Sub-Akut', movementPlane: 'Sagittal', tempo: '1-1-2', secondaryMuscles: [], isMotion: true, targetRpe: 5
  },
  {
    ...
    biomechanics: 'Gluteal zinciri and hamstring kaslarını aktive eder.',
  ...
  },
  {
    ...
    description: 'Sırtüstü yatın. Bir bacağınızı düz tutarak 45 derece yukarı kaldırın and bekleyin.',
    ...
    rehabPhase: 'Akut', movementPlane: 'Sagittal', tempo: '2-2-2', secondaryMuscles: [], isMotion: true, targetRpe: 4
  },
  {
    ...
    biomechanics: 'Dinamik kalça stabilitesi and abduktor kuvveti.',
    safetyFlags: ['Diz Valgus Riski'], equipment: ['Direnç Bandı'], primaryMuscles: ['Gluteus Medius'],
    rehabPhase: 'Kronik', movementPlane: 'Frontal', tempo: 'Step', secondaryMuscles: [], isMotion: true, targetRpe: 7
  },
  {
  ...
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Multi-Planar', tempo: 'Fluid', secondaryMuscles: [], isMotion: true, targetRpe: 2
  },
  {
    ...
    description: 'Herhangi bir pozisyonda kalça kaslarınızı olabildiğince sıkın and 5 saniye bekleyin.',
    biomechanics: 'Gluteal kaslarda nöral aktivasyonu artırır.',
    safetyFlags: ['Yok'], equipment: ['Yok'], primaryMuscles: ['Gluteus Maximus'],
    rehabPhase: 'Akut', movementPlane: 'Static', tempo: '5-0-5', secondaryMuscles: [], isMotion: true, targetRpe: 2
  },
  ...
  // --- CATEGORY 3: UPPER LIMB (SHOULDER & ELBOW) ---
  {
    ...
    biomechanics: 'Omuz ekleminde distraksiyon and pasif mobilizasyon sağlar.',
    safetyFlags: ['Şiddetli Instabilite'], equipment: ['Masa'], primaryMuscles: ['Shoulder Capsule'],
    rehabPhase: 'Akut', movementPlane: 'Circumduction', tempo: 'Fluid', secondaryMuscles: [], isMotion: true, targetRpe: 2
  },
  {
    ...
    description: 'Kollarınızı duvara "W" şeklinde yaslayın and "Y" şekline doğru yukarı kaydırın.',
    biomechanics: 'Serratus anterior aktivasyonu and skapular kontrol.',
    safetyFlags: ['Sıkışma Sendromu'], equipment: ['Duvar'], primaryMuscles: ['Serratus Anterior'],
    rehabPhase: 'Kronik', movementPlane: 'Frontal', tempo: '3-1-3', secondaryMuscles: [], isMotion: true, targetRpe: 6
  },
  {
    ...
    rehabPhase: 'Sub-Akut', movementPlane: 'Transverse', tempo: '2-1-2', secondaryMuscles: [], isMotion: true, targetRpe: 5
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Sagittal', tempo: 'Static', secondaryMuscles: [], isMotion: true, targetRpe: 2
  },
  {
    ...
    biomechanics: 'Skapular protraksiyon and Serratus Anterior kuvvetlendirme.',
    safetyFlags: ['Akut Omuz Ağrısı'], equipment: ['Yok'], primaryMuscles: ['Serratus Anterior'],
    rehabPhase: 'Sub-Akut', movementPlane: 'Sagittal', tempo: '1-0-1', secondaryMuscles: [], isMotion: true, targetRpe: 4
  },
  {
  ...
  },
  {
    ...
    rehabPhase: 'Kronik', movementPlane: 'Transverse', tempo: 'Static', secondaryMuscles: [], isMotion: true, targetRpe: 5
  },
  {
    ...
    rehabPhase: 'Kronik', movementPlane: 'Frontal', tempo: 'Static', secondaryMuscles: [], isMotion: true, targetRpe: 3
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Static', tempo: '5-0-5', secondaryMuscles: [], isMotion: true, targetRpe: 3
  },
  {
    ...
    rehabPhase: 'Sub-Akut', movementPlane: 'Frontal', tempo: '2-1-2', secondaryMuscles: [], isMotion: true, targetRpe: 3
  },
  ...
  // --- CATEGORY 4: STABILITY & BALANCE ---
  {
    ...
    biomechanics: 'Propriyosepsiyon and ayak bileği/kalça stabilitesini artırır.',
    safetyFlags: ['Yüksek Düşme Riski'], equipment: ['Sandalye (Destek için)'], primaryMuscles: ['Core', 'Ankle'],
    rehabPhase: 'Sub-Akut', movementPlane: 'Multi-Planar', tempo: 'Static', secondaryMuscles: [], isMotion: true, targetRpe: 5
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Sagittal', tempo: 'Static', secondaryMuscles: [], isMotion: true, targetRpe: 4
  },
  {
    ...
    biomechanics: 'Dinamik denge and koordinasyonu artırır.',
    safetyFlags: ['Diz Yaralanması'], equipment: ['Yok'], primaryMuscles: ['Global Stabiliers'],
    rehabPhase: 'Kronik', movementPlane: 'Sagittal', tempo: 'Slow', secondaryMuscles: [], isMotion: true, targetRpe: 6
  },
  {
    ...
    biomechanics: 'Quadratus Lumborum and Oblik kaslarını kuvvetlendirir.',
    safetyFlags: ['Omuz Ağrısı'], equipment: ['Mat'], primaryMuscles: ['QL', 'Obliques'],
    rehabPhase: 'Kronik', movementPlane: 'Frontal', tempo: '3-2-3', secondaryMuscles: [], isMotion: true, targetRpe: 8
  },
  {
    ...
    rehabPhase: 'Kronik', movementPlane: 'Transverse', tempo: '1-0-1', secondaryMuscles: [], isMotion: true, targetRpe: 8
  },
  {
    ...
    rehabPhase: 'Performans', movementPlane: 'Multi-Planar', tempo: 'Controlled', secondaryMuscles: [], isMotion: true, targetRpe: 9
  },
  {
    ...
    biomechanics: 'Maksimum lumbopelvik stabilite and koordinasyon.',
    safetyFlags: ['Bel Boşluğu'], equipment: ['Pilates Topu'], primaryMuscles: ['Deep Core'],
    rehabPhase: 'Sub-Akut', movementPlane: 'Sagittal', tempo: '4-0-4', secondaryMuscles: [], isMotion: true, targetRpe: 7
  },
  {
    ...
    biomechanics: 'Posterior zincir kuvveti and dinamik kalça dengesi.',
    safetyFlags: ['Hamstring Gerginliği'], equipment: ['Yok'], primaryMuscles: ['Glutes', 'Hamstrings'],
    rehabPhase: 'Kronik', movementPlane: 'Sagittal', tempo: '3-1-3', secondaryMuscles: [], isMotion: true, targetRpe: 7
  },
  {
    ...
    rehabPhase: 'Kronik', movementPlane: 'Frontal', tempo: 'Slow', secondaryMuscles: [], isMotion: true, targetRpe: 6
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Sagittal', tempo: '2-0-2', secondaryMuscles: [], isMotion: true, targetRpe: 4
  },
  ...
  // --- CATEGORY 5: NEUROLOGICAL ---
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Sagittal', tempo: 'Slow', secondaryMuscles: [], isMotion: true, targetRpe: 4
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Frontal', tempo: 'Fluid', secondaryMuscles: [], isMotion: true, targetRpe: 4
  },
  {
    ...
    rehabPhase: 'Sub-Akut', movementPlane: 'Sagittal', tempo: 'Controlled', secondaryMuscles: [], isMotion: true, targetRpe: 5
  },
  {
    ...
    rehabPhase: 'Kronik', movementPlane: 'Sagittal', tempo: '3-1-3', secondaryMuscles: [], isMotion: true, targetRpe: 6
  },
  {
    ...
    rehabPhase: 'Sub-Akut', movementPlane: 'Sagittal', tempo: 'Steady', secondaryMuscles: [], isMotion: true, targetRpe: 5
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Frontal', tempo: 'Slow', secondaryMuscles: [], isMotion: true, targetRpe: 4
  },
  {
    ...
    rehabPhase: 'Kronik', movementPlane: 'Visual', tempo: 'Patient-led', secondaryMuscles: [], isMotion: true, targetRpe: 2
  },
  {
    ...
    rehabPhase: 'Sub-Akut', movementPlane: 'Multi-Planar', tempo: 'Fast', secondaryMuscles: [], isMotion: true, targetRpe: 6
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Static', tempo: 'Fluid', secondaryMuscles: [], isMotion: true, targetRpe: 2
  },
  {
    ...
    rehabPhase: 'Kronik', movementPlane: 'Transverse', tempo: '2-2-2', secondaryMuscles: [], isMotion: true, targetRpe: 4
  },
  ...
  // --- CATEGORY 6: CARDIOVASCULAR ---
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Deep', tempo: '4-2-6', secondaryMuscles: [], isMotion: true, targetRpe: 2
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Internal', tempo: '2-0-4', secondaryMuscles: [], isMotion: true, targetRpe: 2
  },
  {
    ...
    rehabPhase: 'Sub-Akut', movementPlane: 'Circumduction', tempo: 'Steady', secondaryMuscles: [], isMotion: true, targetRpe: 4
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Sagittal', tempo: 'Fast', secondaryMuscles: [], isMotion: true, targetRpe: 3
  },
  {
    ...
    rehabPhase: 'Kronik', movementPlane: 'Sagittal', tempo: 'Normal', secondaryMuscles: [], isMotion: true, targetRpe: 5
  },
  {
    ...
    rehabPhase: 'Sub-Akut', movementPlane: 'Sagittal', tempo: 'Rhythmic', secondaryMuscles: [], isMotion: true, targetRpe: 6
  },
  {
    ...
    rehabPhase: 'Kronik', movementPlane: 'Sagittal', tempo: 'Continuous', secondaryMuscles: [], isMotion: true, targetRpe: 6
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Internal', tempo: '4-4-4-4', secondaryMuscles: [], isMotion: true, targetRpe: 2
  },
  {
    ...
    rehabPhase: 'Kronik', movementPlane: 'Sagittal', tempo: 'Slow', secondaryMuscles: [], isMotion: true, targetRpe: 8
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Frontal', tempo: '4-1-4', secondaryMuscles: [], isMotion: true, targetRpe: 3
  },
  ...
  // --- CATEGORY 7: POST-OP RECOVERY ---
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Sagittal', tempo: 'Rhythmic', secondaryMuscles: [], isMotion: true, targetRpe: 3
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Sagittal', tempo: 'Slow', secondaryMuscles: [], isMotion: true, targetRpe: 3
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Sagittal', tempo: 'Fluid', secondaryMuscles: [], isMotion: true, targetRpe: 2
  },
  {
  ...
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Internal', tempo: '5-2-5', secondaryMuscles: [], isMotion: true, targetRpe: 3
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Transverse', tempo: 'Safe', secondaryMuscles: [], isMotion: true, targetRpe: 4
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Static', tempo: '5-0-5', secondaryMuscles: [], isMotion: true, targetRpe: 4
  },
  {
    ...
    rehabPhase: 'Kronik', movementPlane: 'Fascial', tempo: 'Gentle', secondaryMuscles: [], isMotion: true, targetRpe: 2
  },
  {
    ...
    rehabPhase: 'Akut', movementPlane: 'Sagittal', tempo: 'Safe', secondaryMuscles: [], isMotion: true, targetRpe: 6
  },
  {
    ...
    rehabPhase: 'Sub-Akut', movementPlane: 'Sagittal', tempo: 'Static', secondaryMuscles: [], isMotion: true, targetRpe: 4
  }
];
